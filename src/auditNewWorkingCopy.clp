...
(defrule test-rule "template testing rule"
	...
	;?toolInfo <- (tools (toolname ?tName)(task "graphic_file_carving") (parameters ?params)(config ?config))
    ?toolInfo <- (tools (toolname ?tName)(task "graphic_file_carving")(parameters ?params)(input ?in)(output ?out)(config ?config))
    =>
